...
console.log("A", self.statement, self.params)
    if (self.verbose) {
...
console.log("A.1.1", JSON.stringify(self.statement))
console.log("A.1.2", JSON.stringify(self.params))
if (_.is.Empty(self.statement)) {
    process.exit()
}
